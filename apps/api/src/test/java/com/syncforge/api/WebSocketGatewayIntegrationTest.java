...
class WebSocketGatewayIntegrationTest extends AbstractIntegrationTest {
    ...
    void joinRoomRejectsNonMemberMissingUserAndUnknownRoom() throws Exception {
        ...
        Map<String, Object> nonMemberReply = nonMember.next();
        ...
        Map<String, Object> missingUserReply = missingUser.next();
        ...
        Map<String, Object> unknownRoomReply = unknownRoom.next();
    ...
    void pingLeaveSocketCloseAndInvalidJsonBehaveCorrectly() throws Exception {
        ...
        Map<String, Object> joined = client.next();
        ...
        Map<String, Object> pong = client.next();
        ...
        Map<String, Object> left = client.next();
        ...
        String closeConnectionId = closeClient.next().get("connectionId").toString();
        closeClient.close();
        Thread.sleep(250);
        ...
        Map<String, Object> error = invalidJson.next();
    ...
    void leaveBeforeJoinReturnsError() throws Exception {
        ...
        Map<String, Object> reply = client.next();
